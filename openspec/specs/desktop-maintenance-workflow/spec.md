...
The Desktop Maintenance workspace SHALL load vehicles from the active Desktop local family and SHALL display history for one selected vehicle at a time.
