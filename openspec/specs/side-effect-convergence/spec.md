## Purpose
Define durable, idempotent convergence between local reminder state and Android notification side effects across cancellation, failure, and process recreation.
